...
\midrule
1.1       & 2026-01-26 & Updates, approved by UNIS LG & Luke Marsden, Stein Haaland     \\
...
UNIS comprises 4 scientific departments - Arctic Geology (AG), Arctic Geophysics (AGF), Arctic Technology (AT) and Arctic Biology (AB). UNIS is funded primarily by Kunnskapsdepartementet (KD), with other income sources including overhead income and infrastructure rental.
...
This version of the data policy was approved by the UNIS leadership group in February, 2026. It shall be reviewed annual by the UNIS leadership group and data management staff at UNIS.
